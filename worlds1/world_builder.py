...
def add_agents(builder, name, condition, exp_version, resistance, duration, no_fires, victims, task, counterbalance_condition):
    ...
    if exp_version == "experiment":
        brain = robot(name = name, condition = condition, resistance = resistance, duration = duration, 
                      no_fires = no_fires, victims = victims, task = task, counterbalance_condition = counterbalance_condition)
        brain2 = firefighter(name = name, condition = condition, resistance = resistance, duration = duration, 
                             no_fires = no_fires, victims = victims, task = task, counterbalance_condition = counterbalance_condition)
        brain3 = firefighter(name = name, condition = condition, resistance = resistance, duration = duration, 
                             no_fires = no_fires, victims = victims, task = task, counterbalance_condition = counterbalance_condition)
        brain4 = firefighter(name = name, condition = condition, resistance = resistance, duration = duration, 
                             no_fires = no_fires, victims = victims, task = task, counterbalance_condition = counterbalance_condition)
...
def create_builder(id, exp_version, name, condition, task, counterbalance_condition):
    ...
    if exp_version == "experiment":
        ...
        if task == 1:
            ...
            no_fires = 7
            victims = 'known'
            builder.add_object((2,8), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            ...
            builder.add_object((16,22), 'source', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            ...
            for i in [(16,19), (15,19), (14,19), (17,19), (17,18), (17,20), (16,18), (16,20), (15,18), (15,20), (14,18), (14,20), (18,19), (18,18), (18,20)]:
                builder.add_object(location = i, name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.75)        
            builder.add_object((16,2), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            builder.add_object((9,16), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True) 
            ...
            builder.add_object((24,1), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            ...
            builder.add_object((17,15), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)          
            ...
            builder.add_object((8,8), 'critically injured woman in area 6', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured woman2.svg")
            builder.add_object((1,22), 'critically injured elderly man in area 11', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man2.svg")
            builder.add_object((17,9), 'critically injured elderly man in area 7', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man.svg")
            ...
            builder.add_object((22,1), 'mildly injured elderly man in area 4', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg")
            builder.add_object((15,15), 'mildly injured man in area 10', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg")
            ...
            builder.add_object((22,2), 'mildly injured woman in area 4', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured woman.svg")
            ...
            builder.add_object((25,12), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman2.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,13), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man2.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            ...
            builder.add_object((25,15), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,16), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,17), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
        ...
        if task == 2:
            ...
            no_fires = 5
            victims = 'unknown'
            builder.add_object((25,8), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,9), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,10), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,11), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,12), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman2.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,13), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,14), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,15), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,16), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,17), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured man2.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((8,8), 'critically injured woman in area 6', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured woman.svg")
            builder.add_object((10,16), 'critically injured woman in area 9', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured woman2.svg")
            ...
            builder.add_object((1,15), 'critically injured elderly woman in area 8', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly woman.svg")
            ...
            builder.add_object((15,2), 'mildly injured elderly man in area 3', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg")
            builder.add_object((16,2), 'mildly injured man in area 3', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured man2.svg")
            ...
            builder.add_object((1,22), 'mildly injured elderly woman in area 11', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg")
            builder.add_object((15,23), 'mildly injured man in area 13', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg")
            ...
            builder.add_object(location = (16,7), name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.25)
            for i in [(16,6), (15,6), (14,6), (17,6), (17,5), (17,4), (16,5), (16,4), (15,5), (15,4), (14,5), (14,4), (18,6), (18,5), (18,4)]:
                builder.add_object(location = i, name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.75)
            
            builder.add_object((23,22), 'source', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)
            builder.add_object(location = (23,21), name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.25)
            for i in [(23,19), (22,19), (21,19), (24,19), (24,18), (24,20), (23,18), (23,20), (22,18), (22,20), (21,18), (21,20), (25,19), (25,18), (25,20)]:
                builder.add_object(location = i, name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.75)
            builder.add_object((17,1), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)
            builder.add_object((2,3), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True) 
            #builder.add_object((23,3), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True)
            builder.add_object((9,7), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True)
            ...
            builder.add_object((3,22), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)
            ...
            builder.add_object((17,22), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)     
        ...
        if task == 3:
            ...
            victims = 'known'
            no_fires = 7
            builder.add_object((25,10), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,11), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,12), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured man.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            builder.add_object((25,13), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            ...
            builder.add_object((25,15), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg", drop_zone_nr = 0, visualize_opacity = 0.5)
            ...
            for i in [(2,19), (1,19), (0,19), (3,19), (3,18), (3,20), (2,18), (2,20), (1,18), (1,20), (0,18), (0,20), (4,19), (4,18), (4,20)]:
                builder.add_object(location = i, name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.75)
            builder.add_object((1,15), 'critically injured woman in area 8', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured woman.svg")
            builder.add_object((1,1), 'critically injured man in area 1', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured man.svg")
            ...
            builder.add_object((22,22), 'mildly injured elderly man in area 14', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg")
            builder.add_object((15,9), 'mildly injured elderly woman in area 7', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg")
            builder.add_object((15,8), 'mildly injured man in area 7', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg")
            builder.add_object((24,22), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            builder.add_object((17,8), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            builder.add_object((9,2), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
            builder.add_object((23,2), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'fast', is_traversable = True, is_movable = True)
        ...
        if task == 4:
            ...
            victims = 'unknown'
            no_fires = 5
            builder.add_object((25,16), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman2.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,15), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,14), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/critically injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            ...
            builder.add_object((25,11), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,10), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,9), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((25,8), name = "Collect Block", callable_class = GhostBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg", drop_zone_nr = 0, visualize_opacity = 0)
            builder.add_object((1,1), 'critically injured elderly man in area 2', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly man.svg")
            ...
            builder.add_object((8,15), 'critically injured man in area 9', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured man.svg")
            builder.add_object((10,2), 'critically injured elderly woman in area 1', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/critically injured elderly woman.svg")
            ...
            builder.add_object((15,8), 'mildly injured man in area 7', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured man.svg")
            builder.add_object((16,8), 'mildly injured elderly man in area 7', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly man.svg")
            builder.add_object((15,16), 'mildly injured elderly woman in area 14', callable_class = CollectableBlock, visualize_shape = 'img', img_name = "/images/mildly injured elderly woman.svg")
            ...
            builder.add_object((17,15), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)
            ...
            for i in [(9,6), (8,6), (7,6), (10,6), (10,5), (10,4), (9,5), (9,4), (8,5), (8,4), (7,5), (7,4), (11,6), (11,5), (11,4)]:
                builder.add_object(location = i, name = 'smog', callable_class = SmokeObject, visualize_shape = 'img', img_name = "/images/smoke.svg", visualize_size = 1.75)
            builder.add_object((17,8), 'fire', FireObject, visualize_shape = 'img', img_name = "/images/fire2.svg", visualize_size = 2, smoke = 'normal', is_traversable = True, is_movable = True)
            #builder.add_object((2,3), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True) 
            #builder.add_object((9,17), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True)
            builder.add_object((2,17), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True)
            #builder.add_object((2,21), 'iron', IronObject, visualize_shape = 'img', img_name = "/images/girder.svg", visualize_size = 1, weight = 100, is_traversable = False, is_movable = True)
    ...
    add_agents(builder, name, condition, exp_version, resistance, duration, no_fires, victims, task, counterbalance_condition)
