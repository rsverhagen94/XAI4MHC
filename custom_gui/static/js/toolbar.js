...
function add_message(chatroom_ID, mssg) {
    ...
    */
    ...
    mssg_content = mssg_content.replaceAll("rescue critically injured woman.", "rescue <img src='/static/images/critically injured woman.svg' height= 30 width=30/>.");
    mssg_content = mssg_content.replaceAll("critically injured woman,", "<img src='/static/images/critically injured woman.svg' height= 30 width=30/>,");
    mssg_content = mssg_content.replaceAll("critically injured woman2", "<img src='/static/images/critically injured woman.svg' height= 30 width=30/>");
    ...
    mssg_content = mssg_content.replaceAll("critically injured elderly man,", "<img src='/static/images/critically injured elderly man.svg' height= 30 width=30/>,");
    mssg_content = mssg_content.replaceAll("critically injured elderly man2", "<img src='/static/images/critically injured elderly man.svg' height= 30 width=30/>");
    mssg_content = mssg_content.replaceAll("rescue critically injured elderly man.", "rescue <img src='/static/images/critically injured elderly man.svg' height= 30 width=30/>.");
...
function my_send_message_function(message) {
    data = {"content":message, "sender": 'human', "receiver": null} // setting receiver to null sends the message to all agents
    send_matrx_api_post_message(matrx_send_message_url, data);
}
